...
Next, we build a multi linear regression model.
...
plot(ml_reg, which=2)
```
The residuals pass the test of independence (Residuals vs Fitted). According to the Q-Q plot, it seems fairly normal but there are outliers at the extremes.
